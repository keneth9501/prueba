...
fecha="venta_"+str(manana.strftime("%d%m%y"))+".xlsx"
...
fecha_at =datetime.strftime((datetime.today() ),'%d/%m/%y')
...
p_open_.to_excel(r'C:\Users\50576\Documents\TAE\data\%s'%fecha,engine='xlsxwriter',
